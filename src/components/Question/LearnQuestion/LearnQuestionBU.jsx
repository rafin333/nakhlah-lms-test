    ...
    <div className="max-w-3xl mx-auto px-4 py-4">
      ...
      {questionDetails?.audio?.data?.attributes?.url && (
        <div className="flex flex-row justify-center items-center mb-4">
          ...
          <Image className="p-3" src={'/icons/All Icon/Slow Audio.svg'} alt="slow audio" width={70} height={70} onClick={() => handleAudioPlay(0.55)} />
          <Image  className="p-3" src={'/icons/All Icon/Fast Audio.svg'} alt="Fast audio" width={70} height={70} onClick={() => handleAudioPlay(0.95)} />
          {/* <FaPlay
